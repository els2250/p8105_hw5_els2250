...
To summarize the homicide data, we will generate a new variable (`city_state`) and count the total number of homicides reported in each city, as well as the number of unsolved homicides, determined by the `disposition` variable claimingn "Closed without arrest" or "Open/No arrest". 
...
The above dataset (`baltimore_prop`) depicts the proportion of unsolved homicides in Baltimore, MD in addition to the estimate's upper and lower limit of the 95% confidence interval. 
